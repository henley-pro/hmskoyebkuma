...
RUN curl -L https://github.com/benbjohnson/litestream/releases/download/v0.5.2/litestream-0.5.2-darwin-arm64.tar.gz -o litestream.tar.gz && tar xzvf litestream.tar.gz
